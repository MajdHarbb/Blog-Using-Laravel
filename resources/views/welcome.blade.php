...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link rel="icon" type="image/x-icon" href="./laravel-fav.png">    
        <title>My Blog</title>
            ...
            @forelse($posts as $post)
                <div class="d-flex my-2">
                    <div class="col-md-4 col-lg-4 col-sm-12">
                        <img style="max-height:250px !important;" class="col-12 img-max-height" src="./images/{{$post->picture}}" alt="Image"/>
                    </div>
                    <div class="px-2 col-md-8 col-lg-8 col-sm-12">
                        <h2>{{$post->title}}</h2>
                        <p>{{$post->body}}</p>
                    </div>
