                    ...
                    <div class="row">
                        <div class="col-md-8 col-lg-8 col-xs-12">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="body" class="form-control" id="exampleFormControlTextarea1" placeholder="Enter post text" rows="3"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4 col-lg-4 col-xs-12 text-center">
                            <div class="form-group">
                                ...
                                <input type="file" name="picture" onchange="updateImage(this)" class="form-control" id="customFile"/>
                            </div>
                        </div>
                    </div>
